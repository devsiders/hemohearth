                    ...
                    <div class="card-body">
                        <form action="../controller/resultado.examenes.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly name="nombre"
                                    value="<?php echo $datos['nombre']; ?> <?php echo $datos['apellido']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="nombre">Documento</label>
                                <input type="text" class="form-control" readonly
                                    value="<?php echo $datos['tipo_documento']; ?>. <?php echo $datos['documento']; ?>">
                            </div>
                            <div class="form-group">
